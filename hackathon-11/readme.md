...
## LOGRO: Utilizar PostgreSQL, NodeJS y Sequelize. 
...
Como referencia vamos a usar la base de datos de veterinaria para:

- Crear una ruta por cada tabla
- Crear un modelo por cada tabla
- Crear un controlador por cada tabla
